	...
	return (
		<div>
			...
			>
				...
				<Button variant={isDragActive ? 'default' : 'outline'} onClick={(e) => e.preventDefault()}>
					{isDragActive ? 'Suelta la imagen aquí' : 'Haz clic o arrastra una imagen aquí'}
				</Button>
			</div>
			{imageSrc && <Image src={imageSrc} alt="Uploaded preview" width={100} height={100} style={{ marginTop: '10px', maxHeight: '100px' }} />}
		</div>
	)
}
